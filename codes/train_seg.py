...
def main():
	...
	parser.add_argument('--num-classes', type=int,
						default=2,
						help='The number of classes in the segmentations dataset.')
	...
	parser.add_argument('--model-store-path', type=str, 
						default='/gpfs/share/home/1701214057/CUB2011/experiments/models/seg', 
						help='the segmentation model store path') 
	...
	for epoch in range(args.num_epochs):
		...
		logger.info('Epoch: {0} / {1}, train loss: {2:.3f}, test loss: {3:.3f}'.format(epoch, args.num_epochs, train_loss, test_loss))
		
		if epoch % 5 == 0:
			model.save_network('deeplabv3p-{}'.format(args.which_model), epoch)
